				...
				<div class="col-lg-10" style="margin: 0 auto; float:none">
					<div class="row">
						<div class="col-lg-4" style="margin: 0 auto; float: none;">
							...
							<div class="col-lg-4" style="margin: 0 auto; float: none;">
								<div class="gallery">
									<a href="manage-prof.php" class="text-light">
										<img src="imgs/professor.png" width="600px" height="400px" alt="View Professors" title="Click to View Professors" />
										<div class="desc text-uppercase">
											Professors (
												<?php
												$getCount->getCountProfessors($conn);
												?>
												)
											</div>
										</a>
								...
								<div class="col-lg-4" style="margin: 0 auto; float: none;">
									<div class="gallery">
										<a href="view_students_list.php" class="text-light">
											...
											<div class="desc text-uppercase">
												Students
												<?php $getCount->getCountStudent($conn, $role, $user_id); ?>
											</div>
										</a>
									</div>
								</div>
